...
import { X, Package, DollarSign, Tag, FileText, BarChart2, Image as ImageIcon, Upload } from 'lucide-react';
        ...
        <>
          ...
          >
            <div className="flex justify-between items-center mb-8">
              <div>
                <h2 className="text-2xl font-bold text-slate-primary">Add New Product</h2>
                <p className="text-slate-secondary text-sm">Enter the details and upload an image</p>
              </div>
